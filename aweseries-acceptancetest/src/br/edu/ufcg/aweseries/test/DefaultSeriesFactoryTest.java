...
public class DefaultSeriesFactoryTest extends TestCase {
    ...
    public void testNotParameterizedCreationReturnsDefaultData() {
        ...
        assertThat(defaultSeries.airDate(),
                equalTo(Dates.parseDate("1996-01-01", DATE_FORMAT, null)));
    ...
    public void testAllParameters() {
        ...
        String airsOn = "";
        String airsAt = "";
        Date firstAired = Dates.parseDate("1997-12-21", DATE_FORMAT, null);
        String runtime = "30";
        String network = "ABC";
        ...
        Series defaultSeries =
                this.factory.createSeries("id : " + id, "name : " + name, "status : " + status,
                        "airsOn : " + airsOn, "airsAt : " + airsAt, "firstAired : " + firstAired,
                        "runtime : " + runtime, "network : " + network, "overview : " + overview,
