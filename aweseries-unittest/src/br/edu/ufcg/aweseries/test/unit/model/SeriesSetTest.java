...
public class SeriesSetTest {
	...
	private Series mockSeries(int id) {
	...
	public void testSize() {
		for (int i=1; i<=10; i++) {
			this.seriesSet.add(this.mockSeries(i));
			Assert.assertEquals(i, this.seriesSet.size());
		}

		for (int i=10; i>=1; i--) {
			this.seriesSet.remove(this.mockSeries(i));
	...
	public void testAddAlreadyExistentSeries() {
		this.seriesSet.add(this.mockSeries(1));
		this.seriesSet.add(this.mockSeries(1));
	}
	...
	public void testRemoveNonExistentSeries() {
		this.seriesSet.remove(this.mockSeries(1));
	}
	...
	public void testRemoveAll() {
		...
		for (int i=1; i<=10; i++) {
			Assert.assertFalse(this.seriesSet.contains(this.mockSeries(i)));
		}
	}
