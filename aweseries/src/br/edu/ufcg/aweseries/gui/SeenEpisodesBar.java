...
public class SeenEpisodesBar extends LinearLayout {
    ...
    public void setSeries(Series series) {
        ...
        chunkBar.setBackgroundColor(getResources().getColor(
                R.color.aweseries_style_chunkbar_background));
        chunkBar.setForegroundColor(getResources().getColor(
                R.color.aweseries_style_chunkbar_foreground));
        chunkBar.setTextColor(getResources().getColor(R.color.aweseries_style_chunkbar_textColor));
        chunkBar.setTextSize(getResources().getDimension(R.dimen.aweseries_style_chunkbar_textSize));
