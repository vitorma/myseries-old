...
public class SeriesDatabase extends SQLiteOpenHelper implements SeriesRepository {
    ...
    private Series seriesByCurrentPositionOf(Cursor c) {
        return Series.builder()
                ...
                .withAirDate(DatesAndTimes.parseDate(c.getLong(c.getColumnIndex(SERIES_AIRDATE)), DEFAULT_AIRDATE))
    ...
    private Episode episodeByCurrentPositionOf(Cursor c) {
        ...
        return Episode.builder()
                ...
                .withAirDate(DatesAndTimes.parseDate(airDate, DEFAULT_AIRDATE))
                .withAirtime(DatesAndTimes.parseDate(airtime, DEFAULT_AIRTIME))
