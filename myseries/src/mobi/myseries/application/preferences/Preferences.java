...
public class Preferences {
    ...
    private static final String KEY_PREFIX_SEASON = "Season";
    ...
    public SeasonPreferences forSeason() {
        return new SeasonPreferences(this.forActivities().addKeyPrefix(KEY_PREFIX_SEASON));
    }
