...
public class EpisodeAdapter implements JsonSerializer<Episode>,
    ...
    public Episode deserialize(JsonElement jsonElement, Type type,
        ...
        return Episode.builder()
                ...
                .withAirDate(DatesAndTimes.parseDate(Objects.nullSafe(episodeJson.get(EPISODE_AIRDATE), JsonNull.INSTANCE).isJsonNull()? null : episodeJson.get(EPISODE_AIRDATE).getAsLong(), DEFAULT_AIRDATE))
                .withAirtime(DatesAndTimes.parseDate(Objects.nullSafe(episodeJson.get(EPISODE_AIRTIME), JsonNull.INSTANCE).isJsonNull()? null : episodeJson.get(EPISODE_AIRTIME).getAsLong(), DEFAULT_AIRTIME))
