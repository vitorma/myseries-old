...
public class ImageDownloader {
    ...
    private ImageDownloader(Context context) {
        ...
        // min API level 8
        this.mDiskCacheDir = Environment.getExternalStorageDirectory().getAbsolutePath()
    ...
    public void download(String url, ImageView imageView) {
        this.download(url, imageView, true);
    }
    ...
    public void download(String url, ImageView imageView, boolean isDiskCaching) {
        ...
        Bitmap bitmap = this.getBitmapFromCache(url);

        if (bitmap == null) {
            this.forceDownload(url, imageView, isDiskCaching);
        } else {
    ...
    class BitmapDownloaderTask extends AsyncTask<String, Void, Bitmap> {
        ...
        public BitmapDownloaderTask(ImageView imageView, boolean isDiskCaching) {
            ...
            this.mIsDiskCaching = isDiskCaching;
        }
        ...
        protected Bitmap doInBackground(String... params) {
            ...
            final String fileName = Integer.toHexString(this.mUrl.hashCode()) + "."
                    + CompressFormat.JPEG.name();
            File imageFile = new File(ImageDownloader.this.mDiskCacheDir + "/" + fileName);

            // try to get bitmap from disk cache first
            if (this.mIsDiskCaching) {
                Bitmap bitmap = ImageDownloader.this.getBitmapFromDisk(this.mUrl, imageFile);
                if (bitmap != null) {
                    return bitmap;
                }
            }
            ...
            return ImageDownloader.this.downloadBitmap(this.mUrl, this.mIsDiskCaching, imageFile);
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            ImageDownloader.this.addBitmapToCache(this.mUrl, bitmap);
    ...
    private Bitmap getBitmapFromCache(String url) {
        ...
        synchronized (this.sHardBitmapCache) {
            final Bitmap bitmap = this.sHardBitmapCache.get(url);
            if (bitmap != null) {
