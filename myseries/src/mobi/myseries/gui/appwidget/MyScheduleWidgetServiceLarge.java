...
public class MyScheduleWidgetServiceLarge extends IntentService {
    ...
    private static final int LAYOUT = R.layout.appwidget_myschedule_old;
    private static final int ITEM_LAYOUT = R.layout.appwidget_myschedule_item_old;
    private static final int EMPTY_VIEW = R.layout.appwidget_empty_view;

    private static final Comparator<Episode> COMPARATOR = EpisodeComparator.byNewestFirst();
    ...
    public void onHandleIntent(Intent intent) {
        ...
        mgr.updateAppWidget(cn, this.buildUpdate(this, LAYOUT, ITEM_LAYOUT, EMPTY_VIEW, this.numberOfItems));
    }
    ...
    protected RemoteViews buildUpdate(Context context, int layout, int itemLayout, int noItemLayout, int limit) {
        ...
        SortedSet<Episode> recent = sortedSetBy(SERIES_PROVIDER.recentEpisodes());

        if (recent.isEmpty()) {
            RemoteViews item = new RemoteViews(context.getPackageName(), noItemLayout);
            item.setTextViewText(R.id.itemName, context.getString(R.string.no_episodes_to_see));
            ...
            while (it.hasNext() && viewToAdd < limit) {
                ...
                item.setImageViewBitmap(R.id.poster, IMAGE_PROVIDER.getPosterOf(series));
        ...
        rv.setTextViewText(R.id.title, context.getText(R.string.recent));
        rv.setTextViewText(R.id.ammountTextView, "99997 a 99998 de 99999");

        //Launch MySchedule - scheduleButton.onClick()
        Intent i2 = MyScheduleActivity.newIntent(context, ScheduleMode.RECENT);
        i2.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        PendingIntent pi2 = PendingIntent.getActivity(context, 2, i2, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        PendingIntent pi3 = PendingIntent.getBroadcast(this, 3, i3, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        PendingIntent pi4 = PendingIntent.getBroadcast(this, 4, i4, PendingIntent.FLAG_UPDATE_CURRENT);
...
//        PendingIntent pi5 = PendingIntent.getBroadcast(this, 5, i5, PendingIntent.FLAG_UPDATE_CURRENT);
//        rv.setOnClickPendingIntent(R.id.lessItemsButton, pi5);
    ...
    protected Class<? extends MyScheduleWidgetProviderLarge> widgetClass() {
