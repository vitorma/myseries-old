...
public class MessageLauncher implements MessageServiceListener {
	...
	public void onFollowingError(Series series, Exception e) {
		...
		if (e instanceof ConnectionFailedException) {
			this.dialogBuilder.setMessage(String.format(this.activity.getString(R.string.add_connection_failed_message),
					                                        series.name()));

		} else if (e instanceof SeriesNotFoundException) {
			this.dialogBuilder.setMessage(String.format(this.activity.getString(R.string.add_series_not_found),
					                                        series.name()));
